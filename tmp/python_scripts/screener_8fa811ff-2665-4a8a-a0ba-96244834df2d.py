...
def calculate_indicators(data_dict):
    for symbol, df in data_dict.items():
        try:
            ...
            print("Error calculating indicators for {}: {}".format(symbol, str(e)))
...
def screen_momentum(data_dict):
    ...
    for symbol, df in data_dict.items():
        try:
            ...
            print("Error screening {}: {}".format(symbol, str(e)))
...
def main():
    try:
        ...
        # Get stock data
        print("Loading stock data for {} symbols...".format(len(symbols)))
